...
export default function App() {
  ...
  const noHeaderViews = ['home', 'job-detail', 'bookmark', 'resume-manage', 'search-result'];
  const noFooterViews = ['survey', 'resume', 'resume-result', 'oauth-callback', 'home', 'job-detail', 'bookmark', 'resume-manage', 'search-result'];
